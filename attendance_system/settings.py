...
# DEBUG is True locally by default, but must be explicitly turned off in production.
# On Render, set the environment variable DEBUG=False.
DEBUG = os.environ.get('DEBUG', 'True') == 'True'

ALLOWED_HOSTS = ['*']  # Render's own domain + ngrok are both covered; tighten if desired.
...
# falls back to local SQLite when that variable isn't present.
DATABASES = {
...
STATIC_ROOT = BASE_DIR / 'staticfiles'  # collectstatic gathers files here for production
STORAGES = {
    "staticfiles": {
...
QR_SESSION_LIFETIME_SECONDS = 600  # 10 minutes
